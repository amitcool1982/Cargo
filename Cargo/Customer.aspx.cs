        ...
        public static string GetCustomers(int PageIndex, int PageSize)
        {
            ...
            if (dtCustomer.Rows.Count > 0)
            {
                for (int i = 0; i < dtCustomer.Rows.Count; i++)
                {
                    ...
                    sb.AppendFormat(@"""1"": ""{0}""", "<div style='text-overflow: ellipsis; width: 100px;overflow: hidden;'><nobr>" + dtCustomer.Rows[i]["email"].ToString().Replace("\"", "\\" + "\"") + "</nobr></div>");
                    sb.Append(",");
                    ...
                    sb.AppendFormat(@"""3"": ""{0}""", "<div style='text-overflow: ellipsis; width: 100px;overflow: hidden;'><nobr>" + dtCustomer.Rows[i]["telepon"].ToString().Replace("\"", "\\" + "\"") + "</nobr></div>");
                    sb.Append(",");
                    ...
                    sb.AppendFormat(@"""5"": ""{0}""", "<div style='text-overflow: ellipsis; width: 100px;overflow: hidden;'><nobr>" + dtCustomer.Rows[i]["join_datetime"].ToString().Replace("\"", "\\" + "\"") + "</nobr></div>");
                    sb.Append(",");
